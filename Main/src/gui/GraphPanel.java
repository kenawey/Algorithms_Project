...
public class GraphPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    String S;
    public void setType(String ss){
    type=ss;
    if(ss=="Directed"){
    DGraph p=(DGraph) this.graph;
    this.graph=p;
    }
    }
    
    public GraphPanel(Graph graph,String S){
       if(S=="Directed"){
   ...
   /* public GraphPanel(DGraph graph){
        this.graph = graph;
